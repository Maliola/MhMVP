...
package com.lib.socialize.share.core.helper;
...
import com.lib.socialize.share.util.BitmapUtil;
import com.lib.socialize.share.util.FileUtil;
...
public class ShareImageHelper {
    ...
    public ShareImageHelper(Context context, LibShareConfiguration shareConfiguration, Callback callback) {
