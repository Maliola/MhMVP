...
public class PopFullScreenSharePlatformSelector extends BaseSharePlatformSelector implements View.OnClickListener {
    ...
    public PopFullScreenSharePlatformSelector(Activity context, View anchorView, OnShareSelectorDismissListener dismissListener, AdapterView.OnItemClickListener itemClickListener) {
    ...
    private void showEnterAnimation() {
        if (enterAnimation == null)
            enterAnimation = AnimationUtils.loadAnimation(getMyContext(), R.anim.socialize_shareboard_animation_in);
    ...
    private void createShareWindowIfNeed() {
        ...
        mContainerView = new RelativeLayout(getMyContext());
        mContainerView.setBackgroundColor(getMyContext().getResources().getColor(R.color.bili_socialize_black_trans));
