...
public class SinaShareHandler extends BaseShareHandler {
    ...
    public SinaShareHandler(Activity context, LibShareConfiguration configuration) {
    ...
    private WeiboAuthListener mAuthListener = new WeiboAuthListener() {
        ...
        public void onWeiboException(WeiboException arg0) {
            if (getShareListener() != null) {
                getShareListener().onError(SocializeMedia.SINA, ShareStatusCode.ST_CODE_SHARE_ERROR_AUTH_FAILED, arg0);
            }
        }
        ...
        public void onComplete(Bundle bundle) {
            ...
            listener.onError(SocializeMedia.SINA, ShareStatusCode.ST_CODE_SHARE_ERROR_AUTH_FAILED, new ShareException("无效的token"));
        }
