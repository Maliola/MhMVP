...
import com.lib.socialize.share.download.DefaultImageDownloader;
import com.lib.socialize.share.download.IImageDownloader;
...
public class LibShareConfiguration implements Parcelable {
    ...
    private String mWeiXinScope;
    private String mQQScope;

    final IImageDownloader mImageDownloader;
    final Executor mTaskExecutor;

    private LibShareConfiguration(Builder builder) {
        ...
        mQQScope = builder.mQQScope;
        mWeiXinScope = builder.mWeiXinScope;
    ...
    public static class Builder {
        ...
        public Builder wechat(String mScope) {
            mWeiXinScope = mScope;
            return this;
        }

        public Builder qq(String mScope) {
            mQQScope = mScope;
            return this;
        }
        ...
        public LibShareConfiguration build() {
            checkFields();
    ...
    protected LibShareConfiguration(Parcel in) {
    ...
    public static final Parcelable.Creator<LibShareConfiguration> CREATOR = new Parcelable.Creator<LibShareConfiguration>() {
        public LibShareConfiguration createFromParcel(Parcel source) {
            return new LibShareConfiguration(source);
        }

        public LibShareConfiguration[] newArray(int size) {
            return new LibShareConfiguration[size];
        }
    };
}
