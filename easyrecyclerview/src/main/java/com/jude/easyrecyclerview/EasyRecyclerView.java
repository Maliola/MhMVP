...
public class EasyRecyclerView extends FrameLayout {
    ...
    protected PullToRefreshRecyclerView mPtrLayout;
    protected PullToRefreshBase.OnRefreshListener<RecyclerView> mRefreshListener;


    public PullToRefreshRecyclerView getSwipeToRefresh() {
        return mPtrLayout;
    }
    ...
    private void initView() {
        ...
        mPtrLayout = (PullToRefreshRecyclerView) v.findViewById(R.id.prz_layout);
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        mErrorView.dispatchTouchEvent(ev);
        if(mPtrLayout.getMode()!= PullToRefreshBase.Mode.DISABLED){
    ...
    private void initProgressAnimation(boolean isStop) {
        View imageView = mProgressView.findViewById(R.id.progress_wheel);
        if (imageView != null && imageView instanceof ImageView) {
            AnimationDrawable animationDrawable = (AnimationDrawable) ((ImageView) imageView).getDrawable();
            if (isStop) {
    ...
    private void initEmptyAnimation(boolean isStop) {
        View imageView =mEmptyView .findViewById(R.id.loading_empty);
        if (imageView != null && imageView instanceof ImageView) {
            AnimationDrawable animationDrawable = (AnimationDrawable) ((ImageView) imageView).getDrawable();
            if (isStop) {
                animationDrawable.stop();
    ...
    public void setErrorView(int errorView) {
        mErrorView.removeAllViews();
        View view = LayoutInflater.from(getContext()).inflate(errorView, null);
    ...
    protected void initRecyclerView(View view) {
        ...
        mRecycler = mPtrLayout.getRefreshableView();
     ...
     * @param listener
     */
    public void setRefreshListener(PullToRefreshBase.OnRefreshListener<RecyclerView> listener) {
        ...
        mPtrLayout.post(new Runnable() {
            ...
            public void run() {
                ...
                if (isRefreshing && isCallbackListener && mRefreshListener != null) {
                    mRefreshListener.onRefresh(mPtrLayout);
                }
            }
        });
    }
