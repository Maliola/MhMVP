...
abstract public class RecyclerArrayAdapter<T> extends RecyclerView.Adapter<BaseViewHolder>   {
    ...
    public static final int CHOICE_MODE_NONE = 3;
            ...
            viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(mChoiceMode==CHOICE_MODE_NONE) {
                        ...
                        switchSelectedState(viewHolder.getAdapterPosition() - headers.size());//切换选中
                    }
                }
            });
        }
    ...
    public void OnBindViewHolder(BaseViewHolder holder, final int position){
        if(mChoiceMode!=CHOICE_MODE_NONE) {
            if (isSelected(position)) {
                holder.hasChioce(true,true);
            } else {
                holder.hasChioce(true,false);
            }
        }else{
            holder.hasChioce(false,false);
        }
