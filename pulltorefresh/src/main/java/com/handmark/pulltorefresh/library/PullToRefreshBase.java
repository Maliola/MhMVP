...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private OnRefreshScrollListener  mOnScrollListener;
	...
	public void setOnRefreshScrollListener(OnRefreshScrollListener listener) {
	...
	protected final void setHeaderScroll(int value) {
		if(mOnScrollListener!=null){
			mOnScrollListener.onScroll(value);
		}
		if (DEBUG) {
	...
	public static interface OnRefreshScrollListener {
