...
public class JUtils {
    ...
    public static void Toast(int  resid){
        android.widget.Toast.makeText(mApplicationContent,resid, android.widget.Toast.LENGTH_SHORT).show();
    }
    ...
    public static void ToastLong(int  resid){
        android.widget.Toast.makeText(mApplicationContent, resid, android.widget.Toast.LENGTH_LONG).show();
    }
