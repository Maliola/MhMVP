...
public class ThreeFragmentPresenter extends BeamListFragmentPresenter<ThreeFragment,String> implements RecyclerArrayAdapter.OnItemClickListener{
    @Override
    protected void onCreateView(ThreeFragment view) {
