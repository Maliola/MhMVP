package com.mahui.mhmvp.presenter.adapter;
...
import com.mahui.mhmvp.presenter.section.Section;
 ...
 */
public class SectionedRecyclerViewAdapter<M> extends RecyclerArrayAdapter<M> {
    ...
    public SectionGridSpanSizeLookup obtainSectionGridSpanSizeLookUp(int maxCount) {

        return new SectionGridSpanSizeLookup(maxCount);
    ...
    public class SectionGridSpanSizeLookup extends GridLayoutManager.SpanSizeLookup {
        ...
        public SectionGridSpanSizeLookup(int maxCount) {
        ...
        public int getSpanSize(int position) {
            ...
            if (getSectionItemViewType(position-headers.size()) == SectionedRecyclerViewAdapter.VIEW_TYPE_HEADER)
                return mMaxCount;
            if (getSectionItemViewType(position-headers.size()) == SectionedRecyclerViewAdapter.VIEW_TYPE_FOOTER)
                return mMaxCount;
            return 1;
        }
    }
