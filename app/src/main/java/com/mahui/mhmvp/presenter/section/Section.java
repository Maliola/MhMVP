 ...
 *
 */
public abstract class Section<M,N> {
     ...
     */
    public final void onBindContentViewHolder(BaseViewHolder holder, int position) {
        switch (state) {
            case LOADING:
     ...
     * @param position position of the item in the Section, not in the RecyclerView
     */
    public abstract void onBindItemViewHolder(BaseViewHolder<N> holder, int position);
     ...
     */
    public BaseViewHolder getLoadingViewHolder(View view) {
        return new SectionedRecyclerViewAdapter.EmptyViewHolder(view);
    }
    /**
     ...
     */
    public void onBindLoadingViewHolder(BaseViewHolder holder) {
        // Nothing to bind here.
    }
     ...
     */
    public BaseViewHolder getFailedViewHolder(View view) {
        return new SectionedRecyclerViewAdapter.EmptyViewHolder(view);
    }
    /**
     ...
     */
    public void onBindFailedViewHolder(BaseViewHolder holder) {
        // Nothing to bind here.
    }
}
