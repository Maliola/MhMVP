...
ShareListActivity<T extends ShareListActivityPresenter, M> extends BaseShareableActivity<T> {
    Context mCtx;
    private ListConfig mListConfig;
    private EasyRecyclerView mListView;
    private ShareListActivityPresenter.DataAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView.setAdapter(mAdapter = getPresenter().getAdapter());

        if (mListConfig.mStartWithProgress && !getPresenter().inited)
